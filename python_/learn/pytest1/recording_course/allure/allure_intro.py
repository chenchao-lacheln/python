...
# 在测试执行期间收集结果
# pytest1 [ 测试文件] -s -q --alluredir=./result/ (--alluredir这个选项用于指定存储测试结果的路径)
# 查看测试报告
...
# pytest1 test_allure_title.py --alluredir ./result -vs --clean-alluredir

# test_allure_links 中的 @allure.issue("140","BUG地址")  添加链接执行命令
#       pytest1 test_allure_links.py --alluredir ./result -vs --allure-link-pattern=issue:https://www.baidu.com/{}

# pytest1 --help | grep allure  查看帮助文档
...
# pytest1 test_allure_feature.py --allure-features="登录模块" --alluredir ./result --clean-alluredir
